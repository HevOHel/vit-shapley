...
def config():
    ...
    # Wandb setting
    wandb_project_name = "wandb_transformer_interpretability_project"
    exp_name = "ImageNette_classifier_vit_tiny_patch16_224_1e-5_train"
    ...
    # Dataset Setting
    datasets = "MURA"  # (ImageNette, MURA)
    dataset_location = f'/media/zhengzhiqiang/MURA-v1.1/'#f'E:/Codes/R/MURA-v1.1'#
    ...
    output_dim = 1
    target_type = 'binary'  # ("binary", "multiclass", "multilabel")
    img_channels = 3
    ...
    classifier_backbone_type = 'vit_tiny_patch16_224'
